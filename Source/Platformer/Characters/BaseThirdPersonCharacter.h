...
class UPunchComponent;
UCLASS(config = Game)
class PLATFORMER_API ABaseThirdPersonCharacter : public ACharacter
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, Category = "PunchSystem")
		UPunchComponent * mPunch;
